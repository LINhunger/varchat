...
<script>
		...
		websocket.onopen = function(event) {
			...
			$("#content").append("<div class='"+msgCss+"'><label class='name'>"+"${msg.senderName}" +"&nbsp;"+"<fmt:formatDate value="${msg.date}" pattern="yyyy-MM-dd HH:mm:ss"/>" +"</label><div class='"+textCss+"'>"+"${msg.text}" +"</div></div>");
			</c:forEach>
			scrollToBottom();
			<c:if test="${empty msgs}">
			$("#content").append("<div class='fmsg'>"+"还没有任何信息"+"</div>");
			scrollToBottom();
			</c:if>
		};
